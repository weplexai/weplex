...
/** Default backdrop for freshly-created spaces — Portal-blue slate. Users
 *  can override via the space modal's HSB picker. */
export const DEFAULT_SPACE_BG_COLOR = '#1a4270';
...
export const spaceStore = {
  ...
  create(
    ...
    const space: Space = {
      ...
      order: spaces.length,
      profileId,
      bgColor: bgColor ?? DEFAULT_SPACE_BG_COLOR,
      directory,
      type: 'personal',
      shared: false,
    };
